...
import Box from './components/Servicebox';
...
<section class="text-gray-400  body-font h-[90vh] ">
  <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 md:mb-0 mb-10">
      <img class="object-cover object-center rounded "  src="PAGE/Capture.PNG" />
    </div>
    <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
      <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-white">For Rapid Growth 
...
<section class="text-gray-400  body-font">
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-wrap -m-4">
     <Box title="FOR SMALL BUSINESS LEVEL"/>
     <Box title="FOR LARGE SCALE BUSINESS"/>
     <Box title="FOR ENTERPRISE LEVEL SCALE "/>
      </div>
  </div>
</section>
